...
class Interceptor extends \Magento\CatalogWidget\Model\Rule\Condition\Product implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addToCollection');
        return $pluginInfo ? $this->___callPlugins('addToCollection', func_get_args(), $pluginInfo) : parent::addToCollection($collection);
    }
