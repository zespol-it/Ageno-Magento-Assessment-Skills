...
class Interceptor extends \Magento\Weee\Model\Tax implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWeeeAmount');
        return $pluginInfo ? $this->___callPlugins('getWeeeAmount', func_get_args(), $pluginInfo) : parent::getWeeeAmount($product, $shipping, $billing, $website, $calculateTax);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWeeeAmountExclTax');
        return $pluginInfo ? $this->___callPlugins('getWeeeAmountExclTax', func_get_args(), $pluginInfo) : parent::getWeeeAmountExclTax($product, $shipping, $billing, $website);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWeeeAttributeCodes');
        return $pluginInfo ? $this->___callPlugins('getWeeeAttributeCodes', func_get_args(), $pluginInfo) : parent::getWeeeAttributeCodes($forceEnabled);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWeeeTaxAttributeCodes');
        return $pluginInfo ? $this->___callPlugins('getWeeeTaxAttributeCodes', func_get_args(), $pluginInfo) : parent::getWeeeTaxAttributeCodes($store, $forceEnabled);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isWeeeInLocation');
        return $pluginInfo ? $this->___callPlugins('isWeeeInLocation', func_get_args(), $pluginInfo) : parent::isWeeeInLocation($countryId, $regionId, $websiteId);
    }
